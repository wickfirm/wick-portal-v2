...
export default function ClientResources({
  ...
  const copyResourceLink = async (resourceId: string, resourceUrl: string) => {
    try {
              ...
              {editingId === resource.id ? (
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 6 }}>
                    <button
                      onClick={() => copyResourceLink(resource.id, resource.url)}
                      title={copiedId === resource.id ? "Copied!" : "Copy link"}
                      style={{
                        padding: "6px 10px",
                        background: copiedId === resource.id ? theme.colors.successBg : theme.colors.bgTertiary,
                        color: copiedId === resource.id ? theme.colors.success : theme.colors.textSecondary,
                        border: "none",
                        borderRadius: 6,
                        fontSize: 12,
                        cursor: "pointer",
