      ...
      <main style={{ maxWidth: 600, margin: "0 auto", padding: "32px 24px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gap: 16 }}>
            <div>
              ...
              <div style={{ padding: "12px 14px", background: theme.colors.bgTertiary, borderRadius: theme.borderRadius.md, fontSize: 14, color: theme.colors.textPrimary }}>
                {user?.name || "—"}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div style={{ padding: "12px 14px", background: theme.colors.bgTertiary, borderRadius: theme.borderRadius.md, fontSize: 14, color: theme.colors.textPrimary, textTransform: "capitalize" }}>
        ...
        <div style={{
          ...
          <form onSubmit={handlePasswordChange}>
            ...
            <button type="submit" disabled={saving} style={{ marginTop: 20, padding: "12px 24px", background: theme.colors.primary, color: "white", border: "none", borderRadius: theme.borderRadius.md, fontSize: 14, fontWeight: 500, cursor: saving ? "not-allowed" : "pointer", opacity: saving ? 0.7 : 1 }}>
